                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <div className="form-group">
                            ...
                            <p style={{marginTop:'-10px'}} className="h4">{"Rp "+numberWithCommas(data.totalharga)}</p>
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            <textarea onChange={(event)=> props.keterangan(event)} name="keterangan" placeholder="Contoh: Pedas" className="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                        </div>                      
                    </div>
                    <div className="modal-footer">
                        <button type="button" className="btn btn-danger" data-dismiss="modal"><span className="h4"><i className="fas fa-trash-alt mr-2"></i>Hapus Pesanan</span></button>
                        <button type="button" className="btn btn-success" data-dismiss="modal"><span className="h4">Simpan</span></button>
                    </div>
                </div>
            </div>
        </div>
